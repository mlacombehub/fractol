...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/23 20:24:09 by mlacombe          #+#    #+#             */
/*   Updated: 2020/02/23 20:46:07 by mlacombe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			mlx_int_xpm_set_pixel(mlx_img_list_t *img, char *data,
	int opp, int col, int x)
{
	*((unsigned int *)(data + 4 * x)) = col;
}

void			*mlx_int_parse_xpm(mlx_ptr_t *xvar, void *info,
...
void			*mlx_xpm_file_to_image(mlx_ptr_t *xvar, char *file,
